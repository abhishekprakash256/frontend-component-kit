...
var useIsomorphicEffect_default2 = isDOM || isReactNative ? import_react4.useLayoutEffect : import_react4.useEffect;
...
function useMediaQuery(query, targetWindow = typeof window === "undefined" ? void 0 : window) {
  ...
  const [matches, setMatches] = (0, import_react5.useState)(() => mql ? mql.matches : false);
...
function createBreakpointHook(breakpointValues) {
  ...
  function useBreakpoint2(breakpointOrMap, direction, window2) {
    ...
    let query = (0, import_react6.useMemo)(() => Object.entries(breakpointMap).reduce((query2, [key, direction2]) => {
...
function NoopTransition({
  ...
  const hasEnteredRef = (0, import_react11.useRef)(inProp);
...
function useRTGTransitionProps(_ref) {
  ...
  return Object.assign({}, props, {
    ...
    ) : (0, import_react12.cloneElement)(children, {
      ref: mergedRef
    })
  });
}
...
var Modal = (0, import_react14.forwardRef)((_ref, ref) => {
  ...
  return (0, import_jsx_runtime7.jsx)(import_jsx_runtime7.Fragment, {
    children: import_react_dom.default.createPortal((0, import_jsx_runtime7.jsxs)(import_jsx_runtime7.Fragment, {
...
var AbstractModalHeader = React11.forwardRef(({
  ...
  const context = (0, import_react15.useContext)(ModalContext_default);
...
function DialogTransition(props) {
  return (0, import_jsx_runtime14.jsx)(OffcanvasToggling_default, {
    ...props
  });
}
...
var Offcanvas = React14.forwardRef(({
  ...
  const modalManager = (0, import_react16.useRef)();
  bsPrefix = useBootstrapPrefix(bsPrefix, "offcanvas");
  const [showOffcanvas, setShowOffcanvas] = (0, import_react16.useState)(false);
  ...
  const renderBackdrop = (0, import_react16.useCallback)((backdropProps) => (0, import_jsx_runtime14.jsx)("div", {
    ...backdropProps,
  ...
  return (0, import_jsx_runtime16.jsxs)(import_jsx_runtime15.Fragment, {
    children: [!showOffcanvas && (responsive || renderStaticNode) && renderDialog({}), (0, import_jsx_runtime14.jsx)(ModalContext_default.Provider, {
      value: modalContext,
...
var NavbarOffcanvas = React15.forwardRef(({
  onHide,
  ...props
}, ref) => {
  const context = (0, import_react17.useContext)(NavbarContext_default);
  const handleHide = useEventCallback(() => {
    context == null || context.onToggle == null || context.onToggle();
    onHide == null || onHide();
  });
  return (0, import_jsx_runtime17.jsx)(Offcanvas_default, {
    ref,
...
var Navbar = React17.forwardRef((props, ref) => {
  ...
  const handleCollapse = (0, import_react18.useCallback)((...args) => {
  ...
  const navbarContext = (0, import_react18.useMemo)(() => ({
    onToggle: () => onToggle == null ? void 0 : onToggle(!expanded),
    bsPrefix,
    expanded: !!expanded,
    expand
  }), [bsPrefix, expanded, expand, onToggle]);
  return (0, import_jsx_runtime19.jsx)(NavbarContext_default.Provider, {
    value: navbarContext,
    children: (0, import_jsx_runtime19.jsx)(SelectableContext_default.Provider, {
      value: handleCollapse,
      children: (0, import_jsx_runtime19.jsx)(Component, {
        ref,
        ...controlledProps,
...
//# sourceMappingURL=chunk-6QMCIQH4.js.map
