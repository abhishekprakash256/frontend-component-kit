...
import {
  ...
  useWaitForDOMRef
} from "./chunk-UQOVD37B.js";
import {
  useMergedRefs_default
} from "./chunk-5EJ4L7IW.js";
import {
...
var Modal = React45.forwardRef(({
  ...
  const renderBackdrop = (0, import_react15.useCallback)((backdropProps) => (0, import_jsx_runtime47.jsx)("div", {
    ...backdropProps,
...
var OverlayTrigger = ({
  ...
  return (0, import_jsx_runtime57.jsxs)(import_jsx_runtime56.Fragment, {
    children: [typeof children === "function" ? children(triggerProps) : (0, import_react20.cloneElement)(children, triggerProps), (0, import_jsx_runtime55.jsx)(Overlay_default2, {
      ...props,
      show,
      onHide: handleHide,
      flip,
...
var ProgressBar = React58.forwardRef(({
  ...
  return (0, import_jsx_runtime63.jsx)("div", {
    ...
    children: children ? map(children, (child) => (0, import_react21.cloneElement)(child, {
      isChild: true
    })) : renderProgressBar({
      min,
      now,
...
function useTabPanel(_ref) {
  ...
  const context3 = (0, import_react22.useContext)(TabContext_default);
...
var Tabs = (props) => {
  ...
  const generateChildId = (0, import_react23.useMemo)(() => generateCustomChildId || ((key, type) => id ? `${id}-${type}-${key}` : null), [id, generateCustomChildId]);
  const tabContext = (0, import_react23.useMemo)(() => ({
    onSelect,
    activeKey,
    transition,
...
var ToastHeader = React72.forwardRef(({
  ...
  const context3 = (0, import_react24.useContext)(ToastContext_default);
...
var Toast = React74.forwardRef(({
  ...
  const delayRef = (0, import_react25.useRef)(delay);
  ...
  const autohideFunc = (0, import_react25.useCallback)(() => {
    if (autohideToast) {
  ...
  const toastContext = (0, import_react25.useMemo)(() => ({
    onClose
  }), [onClose]);
