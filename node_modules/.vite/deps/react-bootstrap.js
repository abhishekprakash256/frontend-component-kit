...
import {
  ...
  map,
  require_warning
} from "./chunk-DILMQAYF.js";
import {
  Row_default
} from "./chunk-DEVJYXUM.js";
import {
...
import {
  ...
  AlertLink_default,
  Alert_default
} from "./chunk-VBNMLWXB.js";
import {
  Anchor_default,
  useCallbackRef,
  useEventListener
} from "./chunk-WOU6U56N.js";
import {
  CloseButton_default,
  ENTERING,
  EXITING,
...
} from "./chunk-42EGHNAL.js";
import {
  Button_default
} from "./chunk-ZCCBHM24.js";
import {
  Col_default,
  useCol
} from "./chunk-PRX5FZVR.js";
import {
  DEFAULT_BREAKPOINTS,
...
var CardHeader = React16.forwardRef(({
  ...
  return (0, import_jsx_runtime14.jsx)(CardHeaderContext_default.Provider, {
    value: contextValue,
    children: (0, import_jsx_runtime14.jsx)(Component2, {
      ref,
      ...props,
...
var CardImg = React17.forwardRef(
  // Need to define the default "as" during prop destructuring to be compatible with styled-components github.com/react-bootstrap/react-bootstrap/issues/3595
  ({
    bsPrefix,
    className,
...
var CardImgOverlay = React18.forwardRef(({
  className,
  bsPrefix,
  as: Component2 = "div",
  ...props
...
var CardLink = React19.forwardRef(({
  className,
  bsPrefix,
  as: Component2 = "a",
  ...props
...
var CardSubtitle = React20.forwardRef(({
  className,
  bsPrefix,
...
var CardText = React21.forwardRef(({
  className,
  bsPrefix,
  as: Component2 = "p",
  ...props
...
var Card = React23.forwardRef(({
  ...
  return (0, import_jsx_runtime21.jsx)(Component2, {
    ...
    children: body ? (0, import_jsx_runtime21.jsx)(CardBody_default, {
      children
    }) : children
  });
});
...
var CardGroup = React24.forwardRef(({
  className,
  bsPrefix,
  as: Component2 = "div",
  ...props
...
var CarouselCaption = React25.forwardRef(({
  className,
  bsPrefix,
  as: Component2 = "div",
  ...props
...
var CarouselItem = React26.forwardRef(({
  ...
  const finalClassName = (0, import_classnames24.default)(className, useBootstrapPrefix(bsPrefix, "carousel-item"));
...
var Carousel = React27.forwardRef(({
  ...
  const {
    ...
    onTouchMove,
    onTouchEnd,
    prevIcon = (0, import_jsx_runtime25.jsx)("span", {
      "aria-hidden": "true",
      className: "carousel-control-prev-icon"
    }),
    prevLabel = "Previous",
    nextIcon = (0, import_jsx_runtime25.jsx)("span", {
      "aria-hidden": "true",
  ...
  return (0, import_jsx_runtime26.jsxs)(Component2, {
    ref: elementRef,
    ...props,
    ...
    className: (0, import_classnames25.default)(className, prefix, slide && "slide", fade && `${prefix}-fade`, variant && `${prefix}-${variant}`),
    children: [indicators && (0, import_jsx_runtime25.jsx)("div", {
      className: `${prefix}-indicators`,
      children: map(children, (_, index) => (0, import_jsx_runtime25.jsx)("button", {
        type: "button",
        "data-bs-target": "",
      ...
      children: map(children, (child, index) => {
        ...
        return slide ? (0, import_jsx_runtime25.jsx)(TransitionWrapper_default, {
          in: isActive,
          onEnter: isActive ? handleEnter : void 0,
          onEntered: isActive ? handleEntered : void 0,
          addEndListener: transitionEndListener,
          children: (status, innerProps) => React27.cloneElement(child, {
            ...innerProps,
            className: (0, import_classnames25.default)(child.props.className, isActive && status !== "entered" && orderClassName, (status === "entered" || status === "exiting") && "active", (status === "entering" || status === "exiting") && directionalClassName)
          })
        }) : React27.cloneElement(child, {
          className: (0, import_classnames25.default)(child.props.className, isActive && "active")
        });
      })
    }), controls && (0, import_jsx_runtime26.jsxs)(import_jsx_runtime27.Fragment, {
      children: [(wrap || activeIndex !== 0) && (0, import_jsx_runtime26.jsxs)(Anchor_default, {
        className: `${prefix}-control-prev`,
        onClick: prev,
        children: [prevIcon, prevLabel && (0, import_jsx_runtime25.jsx)("span", {
          className: "visually-hidden",
          children: prevLabel
        })]
      }), (wrap || activeIndex !== numChildren - 1) && (0, import_jsx_runtime26.jsxs)(Anchor_default, {
        className: `${prefix}-control-next`,
        onClick: next,
        children: [nextIcon, nextLabel && (0, import_jsx_runtime25.jsx)("span", {
          className: "visually-hidden",
          children: nextLabel
        })]
      })]
...
var DropdownContext = React28.createContext(null);
...
var DropdownDivider = React34.forwardRef(({
  className,
  bsPrefix,
  as: Component2 = "hr",
  role = "separator",
...
var DropdownHeader = React35.forwardRef(({
  className,
  bsPrefix,
  as: Component2 = "div",
  role = "heading",
...
var DropdownItem2 = React36.forwardRef(({
  bsPrefix,
  className,
  eventKey,
  disabled = false,
  ...
  return (0, import_jsx_runtime34.jsx)(Component2, {
    ...
    ...dropdownItemProps,
    ref,
    className: (0, import_classnames28.default)(className, prefix, meta.isActive && "active", disabled && "disabled")
  });
});
...
var DropdownItemText = React37.forwardRef(({
  className,
  bsPrefix,
  as: Component2 = "span",
  ...props
...
var context3 = React38.createContext(null);
...
var DropdownMenu2 = React39.forwardRef(({
  bsPrefix,
  className,
  align,
  rootCloseEvent,
  ...
  return (0, import_jsx_runtime36.jsx)(Component2, {
    ...
    className: (0, import_classnames30.default)(className, prefix, show && "show", alignEnd && `${prefix}-end`, variant && `${prefix}-${variant}`, ...alignClasses)
  });
});
...
var DropdownToggle2 = React40.forwardRef(({
  bsPrefix,
  split,
  className,
  childBsPrefix,
  ...
  return (0, import_jsx_runtime37.jsx)(Component2, {
    className: (0, import_classnames31.default)(className, prefix, split && `${prefix}-split`, (dropdownContext == null ? void 0 : dropdownContext.show) && "show"),
    ...toggleProps,
    ...props
  });
});
...
var Dropdown2 = React41.forwardRef((pProps, ref) => {
  const {
    bsPrefix,
    drop = "down",
    show,
  ...
  return (0, import_jsx_runtime38.jsx)(DropdownContext_default2.Provider, {
    ...
    children: (0, import_jsx_runtime38.jsx)(Dropdown_default, {
      ...
      children: isInputGroup ? props.children : (0, import_jsx_runtime38.jsx)(Component2, {
        ...props,
        ref,
        className: (0, import_classnames32.default)(className, show && "show", directionClasses[drop])
      })
    })
  });
});
...
var DropdownButton = React42.forwardRef(({
  title,
  children,
  bsPrefix,
  rootCloseEvent,
...
var FigureImage = React44.forwardRef(({
  className,
  fluid = true,
  ...props
...
var FigureCaption = React45.forwardRef(({
  className,
  bsPrefix,
...
var InputGroupText = React47.forwardRef(({
  className,
  bsPrefix,
  as: Component2 = "span",
  ...props
...
var InputGroup = React48.forwardRef(({
  bsPrefix,
  size: size2,
  hasValidation,
  className,
  ...
  return (0, import_jsx_runtime46.jsx)(InputGroupContext_default.Provider, {
    ...
    children: (0, import_jsx_runtime46.jsx)(Component2, {
      ref,
      ...props,
      className: (0, import_classnames38.default)(className, bsPrefix, size2 && `${bsPrefix}-${size2}`, hasValidation && "has-validation")
    })
  });
});
...
var ListGroupItem = React49.forwardRef(({
  bsPrefix,
  active,
  disabled,
  eventKey,
...
var ListGroup = React50.forwardRef((props, ref) => {
  const {
    className,
...
var ModalBody = React51.forwardRef(({
  className,
  bsPrefix,
  as: Component2 = "div",
  ...props
...
var ModalDialog = React52.forwardRef(({
  bsPrefix,
  className,
  contentClassName,
  centered,
  ...
  return (0, import_jsx_runtime50.jsx)("div", {
    ...props,
    ref,
    className: (0, import_classnames42.default)(dialogClass, className, size2 && `${bsPrefix}-${size2}`, centered && `${dialogClass}-centered`, scrollable && `${dialogClass}-scrollable`, fullscreen && fullScreenClass),
    children: (0, import_jsx_runtime50.jsx)("div", {
      className: (0, import_classnames42.default)(`${bsPrefix}-content`, contentClassName),
      children
    })
  });
});
...
var ModalFooter = React53.forwardRef(({
  className,
  bsPrefix,
  as: Component2 = "div",
  ...props
...
var ModalHeader = React54.forwardRef(({
  ...
  return (0, import_jsx_runtime52.jsx)(AbstractModalHeader_default, {
    ref,
    ...props,
...
function DialogTransition(props) {
  return (0, import_jsx_runtime54.jsx)(Fade_default, {
    ...props,
    timeout: null
  });
}
...
var Modal = React56.forwardRef(({
  ...
  const renderBackdrop = (0, import_react28.useCallback)((backdropProps) => (0, import_jsx_runtime54.jsx)("div", {
    ...backdropProps,
  ...
  const renderDialog = (dialogProps) => (0, import_jsx_runtime54.jsx)("div", {
    role: "dialog",
    ...dialogProps,
    style: baseModalStyle,
    className: (0, import_classnames46.default)(className, bsPrefix, animateStaticModal && `${bsPrefix}-static`, !animation && "show"),
    ...
    "aria-labelledby": ariaLabelledby,
    "aria-describedby": ariaDescribedby,
    children: (0, import_jsx_runtime54.jsx)(Dialog, {
      ...props,
  ...
  return (0, import_jsx_runtime54.jsx)(ModalContext_default.Provider, {
    value: modalContext,
    children: (0, import_jsx_runtime54.jsx)(Modal_default, {
      show,
      ref: mergedRef,
      backdrop,
      container,
...
var NavDropdown = React57.forwardRef(({
  ...
  return (0, import_jsx_runtime56.jsxs)(Dropdown_default2, {
    ref,
    ...props,
    className: (0, import_classnames47.default)(className, navItemPrefix),
    children: [(0, import_jsx_runtime55.jsx)(Dropdown_default2.Toggle, {
      id,
      eventKey: null,
      active,
      disabled,
      ...
      as: NavLink_default,
      children: title
    }), (0, import_jsx_runtime55.jsx)(Dropdown_default2.Menu, {
      role: menuRole,
      renderOnMount: renderMenuOnMount,
      rootCloseEvent,
      variant: menuVariant,
...
var Popover = React62.forwardRef(({
  ...
  return (0, import_jsx_runtime60.jsxs)("div", {
    ref,
    role: "tooltip",
    style: computedStyle,
    ...
    children: [(0, import_jsx_runtime59.jsx)("div", {
      ...
      ...arrowProps
    }), body ? (0, import_jsx_runtime59.jsx)(PopoverBody_default, {
      children
    }) : children]
  });
});
...
var Tooltip = React63.forwardRef(({
  ...
  return (0, import_jsx_runtime62.jsxs)("div", {
    ...
    role: "tooltip",
    "x-placement": primaryPlacement,
    className: (0, import_classnames51.default)(className, bsPrefix, `bs-tooltip-${bsDirection}`),
    ...props,
...
var Overlay2 = React64.forwardRef(({
  ...
  return (0, import_jsx_runtime63.jsx)(Overlay_default, {
    ...outerProps,
    ref: mergedRef,
    popperConfig: {
      ...popperConfig,
...
var OverlayTrigger = ({
  ...
  return (0, import_jsx_runtime66.jsxs)(import_jsx_runtime65.Fragment, {
    children: [typeof children === "function" ? children(triggerProps) : (0, import_react33.cloneElement)(children, triggerProps), (0, import_jsx_runtime64.jsx)(Overlay_default2, {
      ...props,
      show,
      onHide: handleHide,
      flip: flip2,
...
var PageItem = React66.forwardRef(({
  ...
  return (0, import_jsx_runtime67.jsx)("li", {
    ref,
    style,
    ...
    children: (0, import_jsx_runtime68.jsxs)(Component2, {
      className: (0, import_classnames53.default)("page-link", linkClassName),
      style: linkStyle,
      ...props,
      children: [children, active && activeLabel && (0, import_jsx_runtime67.jsx)("span", {
        className: "visually-hidden",
...
function createButton(name, defaultValue, label = name) {
  const Button = React66.forwardRef(({
    children,
    ...props
  }, ref) => (0, import_jsx_runtime68.jsxs)(PageItem, {
    ...props,
    ref,
    children: [(0, import_jsx_runtime67.jsx)("span", {
      "aria-hidden": "true",
      children: children || defaultValue
    }), (0, import_jsx_runtime67.jsx)("span", {
      className: "visually-hidden",
      children: label
    })]
  }));
...
var Pagination = React67.forwardRef(({
  ...
  return (0, import_jsx_runtime69.jsx)("ul", {
    ref,
    ...props,
...
function usePlaceholder({
  ...
  return {
    ...colProps,
    className: (0, import_classnames55.default)(className, animation ? `${bsPrefix}-${animation}` : bsPrefix, size2 && `${bsPrefix}-${size2}`, bg && `bg-${bg}`)
  };
}
...
var PlaceholderButton = React68.forwardRef((props, ref) => {
  ...
  return (0, import_jsx_runtime70.jsx)(Button_default2, {
    ...placeholderProps,
    ref,
    disabled: true,
    tabIndex: -1
...
function renderProgressBar({
  ...
  return (0, import_jsx_runtime72.jsx)("div", {
    ...
    ...props,
    role: "progressbar",
    className: (0, import_classnames56.default)(className, `${bsPrefix}-bar`, {
      [`bg-${variant}`]: variant,
    ...
    "aria-valuemin": min2,
    "aria-valuemax": max2,
    children: visuallyHidden ? (0, import_jsx_runtime72.jsx)("span", {
      className: "visually-hidden",
      children: label
    }) : label
  });
...
var Ratio = React71.forwardRef(({
  ...
  return (0, import_jsx_runtime73.jsx)("div", {
    ...
    className: (0, import_classnames57.default)(bsPrefix, className, !isCustomRatio && `${bsPrefix}-${aspectRatio}`),
...
var Spinner = React72.forwardRef(({
  bsPrefix,
  variant,
  animation = "border",
  size: size2,
  ...
  return (0, import_jsx_runtime74.jsx)(Component2, {
    ref,
    ...props,
    className: (0, import_classnames58.default)(className, bsSpinnerPrefix, size2 && `${bsSpinnerPrefix}-${size2}`, variant && `text-${variant}`)
  });
});
...
var SplitButton = React73.forwardRef(({
  id,
  bsPrefix,
  size: size2,
  variant,
  ...
  flip: flip2,
  ...props
}, ref) => (0, import_jsx_runtime76.jsxs)(Dropdown_default2, {
  ref,
  ...props,
  as: ButtonGroup_default,
  children: [(0, import_jsx_runtime75.jsx)(Button_default2, {
    size: size2,
    variant,
    ...
    type,
    children: title
  }), (0, import_jsx_runtime75.jsx)(Dropdown_default2.Toggle, {
    split: true,
    id,
    size: size2,
    variant,
...
var TabPanel = React75.forwardRef(
  // Need to define the default "as" during prop destructuring to be compatible with styled-components github.com/react-bootstrap/react-bootstrap/issues/3595
  (_ref2, ref) => {
    let {
      as: Component2 = "div"
    ...
    return (0, import_jsx_runtime78.jsx)(TabContext_default.Provider, {
      ...
      children: (0, import_jsx_runtime78.jsx)(SelectableContext_default.Provider, {
        ...
        children: (0, import_jsx_runtime78.jsx)(Transition, {
          ...
          mountOnEnter,
          unmountOnExit,
          children: (0, import_jsx_runtime78.jsx)(Component2, Object.assign({}, tabPanelProps, {
            ref,
            hidden: !isActive,
...
var TabContainer = ({
  transition,
  ...props
}) => (0, import_jsx_runtime80.jsx)(Tabs_default, {
  ...props,
...
var TabContent = React78.forwardRef(({
  className,
  bsPrefix,
  as: Component2 = "div",
  ...props
...
var TabPane = React79.forwardRef(({
  bsPrefix,
  transition,
  ...props
}, ref) => {
  ...
  return (0, import_jsx_runtime82.jsx)(TabContext_default.Provider, {
    ...
    children: (0, import_jsx_runtime82.jsx)(SelectableContext_default.Provider, {
      ...
      children: (0, import_jsx_runtime82.jsx)(Transition, {
        ...
        mountOnEnter,
        unmountOnExit,
        children: (0, import_jsx_runtime82.jsx)(Component2, {
          ...rest,
          ref,
          className: (0, import_classnames61.default)(className, prefix, isActive && "active")
        })
      })
    })
  });
...
var Table = React80.forwardRef(({
  ...
  const classes = (0, import_classnames62.default)(className, decoratedBsPrefix, variant && `${decoratedBsPrefix}-${variant}`, size2 && `${decoratedBsPrefix}-${size2}`, striped && `${decoratedBsPrefix}-${typeof striped === "string" ? `striped-${striped}` : "striped"}`, bordered && `${decoratedBsPrefix}-bordered`, borderless && `${decoratedBsPrefix}-borderless`, hover && `${decoratedBsPrefix}-hover`);
  const table = (0, import_jsx_runtime83.jsx)("table", {
    ...props,
    className: classes,
    ref
  });
