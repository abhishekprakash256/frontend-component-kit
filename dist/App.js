...
function App() {
    return (_jsxs(_Fragment, { children: [_jsx(NavBar, {}), _jsxs(CustomBody, { children: [_jsx(HeadingBar, { title: title }), _jsx(CardBundle, {}), _jsx(More, { more_link: more_link }), _jsx(HeadingBar, { title: title }), _jsx(CardBundle, {}), _jsx(HeadingBar, { title: "Chat App" }), _jsx(ArticleImage, { image_link: article_image }), _jsx(HeadingBar, { title: "MarkDown Block" }), _jsx(MarkDown, { mark_down_data: mark_down_data }), _jsx(More, { more_link: more_link }), _jsx(Para, { description: description }), _jsx(SocialMediaLinks, { github_link: socialLinks[0], linkedin_link: socialLinks[1], twitter_link: "", leetcode_link: socialLinks[3], gitlab_link: socialLinks[4], kaggle_link: socialLinks[5], medium_link: "" }), _jsx(SpaceBlock, {}), "  "] }), _jsx(Footer, {})] }));
}
export default App;
