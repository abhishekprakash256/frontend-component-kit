...
const CardsPaignation = ({ cardData }) => {
    ...
    return (_jsxs(Container, Object.assign({ className: "p-0" }, { children: [_jsx(Row, Object.assign({ className: "" }, { children: currentCards.map((card, index) => (_jsx(Col, Object.assign({ xs: 12, sm: 12, md: 4, className: "mt-3" }, { children: _jsx(CardExp, { card_title: card.card_title, card_para: card.card_para, img_src: card.img_src, card_url: card.card_url }) }), index))) })), totalPages > 1 && (_jsx(Row, Object.assign({ className: "rounded background-color-body mt-3 p-3 justify-content-center m-0" }, { children: _jsx(Col, Object.assign({ className: "text-center" }, { children: _jsxs(Pagination, Object.assign({ size: "sm", className: "justify-content-center" }, { children: [_jsx(Pagination.First, { onClick: () => handlePageChange(1), disabled: currentPage === 1 }), _jsx(Pagination.Prev, { onClick: () => handlePageChange(currentPage - 1), disabled: currentPage === 1 }), [...Array(totalPages)].map((_, i) => (_jsx(Pagination.Item, Object.assign({ active: i + 1 === currentPage, onClick: () => handlePageChange(i + 1) }, { children: i + 1 }), i + 1))), _jsx(Pagination.Next, { onClick: () => handlePageChange(currentPage + 1), disabled: currentPage === totalPages }), _jsx(Pagination.Last, { onClick: () => handlePageChange(totalPages), disabled: currentPage === totalPages })] })) })) })))] })));
};
